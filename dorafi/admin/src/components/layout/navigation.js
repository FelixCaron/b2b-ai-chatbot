...
// guest gets — used to carry their own hand-written copy of these tabs, in
...
import { LayoutDashboard, Users, Sparkles, MessageSquare } from 'lucide-react';

export const NAV_ITEMS = [
  { view: 'dashboard', label: 'Dashboard', icon: LayoutDashboard, iconClassName: '' },
  { view: 'conversations', label: 'Conversations', icon: MessageSquare, iconClassName: 'text-brand-500' },
