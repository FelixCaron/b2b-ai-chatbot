...
export default function Footer({ onNavigate }) {
  ...
  return (
    <footer className="max-w-7xl mx-auto px-4 sm:px-8 py-8 mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-gray-500 border-t border-dark-900/10">
      ...
      {/* The parent company's own site (logafi) — a different deployment
          on a different domain, so this is an ordinary outbound link, not a
          view of this app. */}
      <a
        href="https://logafi.com"
        target="_blank"
