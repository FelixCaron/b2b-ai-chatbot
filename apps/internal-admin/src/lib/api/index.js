...
export const staff = {
  ...
  updateSite: (payload) => callEndpoint(contracts.staff.updateSite, payload),
  listSitePages: (payload) => callEndpoint(contracts.staff.listSitePages, payload),
  removeSitePages: (payload) => callEndpoint(contracts.staff.removeSitePages, payload),
  reindexSitePages: (payload) => callEndpoint(contracts.staff.reindexSitePages, payload),
