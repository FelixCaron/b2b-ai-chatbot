...
const PLANS = [
  ...
  {
    id: 'pro',
    name: 'Pro Appointment & Support',
    price: '80',
    currency: 'CAD',
    description: "Ideal for businesses looking to automate customer service, support emails, and book qualified appointments 24/7.",
    popular: true,
    features: [
      'Up to 5 Websites',
      ...
      'Calendar Integration (Google, Calendly, Teams)',
      'Automated Support Email Forwarding',
