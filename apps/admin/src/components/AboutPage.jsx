  ...
  return (
    <div className="py-12 px-6 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="bg-white border border-surface-300 p-8 rounded-3xl shadow-sm">
      ...
      <div className="text-center p-10 bg-gradient-to-br from-brand-800 to-brand-600 border border-brand-500/30 rounded-3xl relative overflow-hidden">
