...
try {
  ...
  console.log("âœ“ Valid ChatRequestSchema passed");
  passed++;
} catch (err) {
  console.error("âŒ Valid ChatRequestSchema failed:", err);
  failed++;
}
...
try {
  ...
  console.log("âœ“ Valid StartScanSchema passed");
  passed++;
} catch (err) {
  console.error("âŒ Valid StartScanSchema failed:", err);
  failed++;
}
...
try {
  ...
  console.log("âœ“ Valid LeadSchema passed");
  passed++;
} catch (err) {
  console.error("âŒ Valid LeadSchema failed:", err);
  failed++;
}
...
try {
  ...
  console.error("âŒ Invalid ChatRequestSchema should have thrown");
  failed++;
} catch (err) {
  console.log("âœ“ Invalid ChatRequestSchema properly rejected");
  passed++;
}
